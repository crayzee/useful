from sqlalchemy import Column, Integer, String, DateTime, Boolean, sql, ForeignKey
...
class SocialAccount(Base):
    ''' Model social accounts
        about auth through facebook, google etc.
        https://www.youtube.com/watch?v=7lrNp4VsC1E
        timing: 45:00
    '''
